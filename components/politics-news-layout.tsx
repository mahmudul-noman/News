                        ...
                        >
                            <Link href={getArticleLink(article)} className="contents">
                                ...
                                <div className="flex-grow">
                                    <h3 className="font-medium text-sm leading-snug group-hover:text-red-600 transition-colors line-clamp-3">
                                        {article.title}
                                    </h3>
                                </div>
                            </Link>
                    ...
                    <article className="group h-full flex flex-col">
                        <Link href={getArticleLink(mainArticle)} className="flex flex-col h-full">
                            ...
                            <div className="flex flex-col flex-shrink-0">
                                <h3 className="font-bold text-xl md:text-2xl leading-tight group-hover:text-red-600 transition-colors mb-2">
                                    {mainArticle.title}
                                </h3>
                ...
                <div className="lg:col-span-1 order-3 lg:order-3 h-full pl-4 flex flex-col gap-6">
                    ...
                    {rightSideArticle && (
                        <article className="group flex flex-col">
                            <Link href={getArticleLink(rightSideArticle)} className="flex flex-col">
                                <div className="relative w-full aspect-[16/9] overflow-hidden rounded-lg bg-gray-200 mb-3">
                                    <Image
                                ...
                                <h3 className="font-medium text-base leading-snug group-hover:text-red-600 transition-colors">
